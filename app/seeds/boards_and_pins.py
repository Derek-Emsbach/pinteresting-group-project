...
def seed_boards_and_pins():
    ...
    gamingPins = [
        ...
        Pin(userId=3, title="jimmy9", save=False, url="pinUrl",
            imageUrl="https://www.pcinvasion.com/wp-content/uploads/2022/08/overwatch-2-premium.jpg"),
        Pin(userId=3, title="jimmy10", save=False, url="pinUrl",
    ...
    animalPins = [
        ...
        Pin(userId=4, title="aman5", save=False, url="pinUrl",
            imageUrl="https://i.pinimg.com/originals/7f/64/3f/7f643f0db514d7971349c416e29e42a8.jpg"),
        Pin(userId=4, title="aman6", save=False, url="pinUrl",
    ...
    carPins = [
        ...
        Pin(userId=5, title="chris10", save=False, url="pinUrl",
