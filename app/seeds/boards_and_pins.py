...
def seed_boards_and_pins():
    ...
    create_board_with_pins(
        db, 13, 'Cakes',
        'https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?auto=format&q=60',
        cake_images
    )

    create_board_with_pins(
        db, 12, 'Summer Camp',
        'https://images.unsplash.com/photo-1517164850305-99a3e65bb47e?auto=format&q=60',
        camp_images
    )

    create_board_with_pins(
        db, 1, 'Christmas',
        'https://images.unsplash.com/photo-1543589077-47d81606c1bf?auto=format&q=60',
        christmas_images
    )

    create_board_with_pins(
        db, 1, 'Decor',
        'https://images.unsplash.com/photo-1554995207-c18c203602cb?auto=format&q=60',
        decor_images
    )

    create_board_with_pins(
        db, 1, 'Dogs I Want',
        'https://images.unsplash.com/photo-1518717758536-85ae29035b6d?auto=format&q=60',
        dog_images
    )

    create_board_with_pins(
        db, 11, 'Food',
        'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?auto=format&q=60',
        food_images
    )

    create_board_with_pins(
        db, 10, 'Halloween',
        'https://images.unsplash.com/photo-1633628569245-1a939e025ebb?auto=format&q=60',
        halloween_images
    )

    create_board_with_pins(
        db, 1, 'Nature',
        'https://images.unsplash.com/photo-1426604966848-d7adac402bff?auto=format&q=60',
        nature_images
    )

    create_board_with_pins(
        db, 9, 'Plants',
        'https://images.unsplash.com/photo-1463554050456-f2ed7d3fec09?auto=format&q=60',
        plant_images
    )

    create_board_with_pins(
        db, 4, 'Puppies',
        'https://images.unsplash.com/photo-1525253013412-55c1a69a5738?auto=format&q=60',
        puppies_images
    )

    create_board_with_pins(
        db, 7, 'Snowboarding',
        'https://images.unsplash.com/photo-1611124600582-c9ef0e977585?auto=format&q=60',
        snow_images
    )

    create_board_with_pins(
        db, 8, 'Wedding Flowers',
        'https://images.unsplash.com/photo-1593470309378-bf460a1c7f10?auto=format&q=60',
        wedding_flower_images
    )

    create_board_with_pins(
        db, 8, 'Wedding Ideas',
        'https://images.unsplash.com/photo-1610173827043-9db50e0d8ef9?auto=format&q=60',
        wedding_images
    )
